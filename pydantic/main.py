...
from .fields import MAPPING_LIKE_SHAPES, Field, FieldInfo, ModelField, ModelPrivateAttr, PrivateAttr, Undefined, ComputedField
...
class BaseModel(Representation, metaclass=ModelMetaclass):
    if TYPE_CHECKING:
        ...
        __computed_fields__: ClassVar[Dict[str, ComputedField]] = {}
